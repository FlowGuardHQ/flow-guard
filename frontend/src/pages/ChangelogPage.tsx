...
import { Search, Calendar, Package, AlertCircle, CheckCircle2, Wrench, Shield, Sparkles, ArrowLeft } from 'lucide-react';
                            ...
                            <div>
                                ...
                                <div className="space-y-2">
                                    <button
                                        ...
                                        className={`block w-full text-left text-sm py-1 transition-colors ${!selectedSection ? 'text-primary font-medium' : 'text-textSecondary hover:text-textPrimary'
                                            }`}
                                    >
                                        All Changes
                                    </button>
                                    <button
                                        ...
                                        className={`block w-full text-left text-sm py-1 transition-colors ${selectedSection === 'added' ? 'text-primary font-medium' : 'text-textSecondary hover:text-textPrimary'
                                            }`}
                                    >
                                        Added
                                    </button>
                                    <button
                                        ...
                                        className={`block w-full text-left text-sm py-1 transition-colors ${selectedSection === 'changed' ? 'text-primary font-medium' : 'text-textSecondary hover:text-textPrimary'
                                            }`}
                                    >
                                        Changed
                                    </button>
                                    <button
                                        ...
                                        className={`block w-full text-left text-sm py-1 transition-colors ${selectedSection === 'fixed' ? 'text-primary font-medium' : 'text-textSecondary hover:text-textPrimary'
                                            }`}
                                    >
                                        Fixed
                                    </button>
                    ...
                    <div className="lg:col-span-3">
                                ...
                                >
                                    ...
                                    <div className="mb-6">
                                        <div className="flex flex-wrap items-center gap-3 mb-4">
                                            ...
                                            <span className={`px-3 py-1 text-xs font-semibold rounded-full border ${STATUS_STYLES[entry.status]}`}>
                                                {entry.status.toUpperCase()}
                                            </span>
                                            <span className={`px-3 py-1 text-xs font-semibold rounded-full border ${NETWORK_STYLES[entry.network]}`}>
                                    ...
                                    {/* Added */}
                                    {entry.added && entry.added.length > 0 && (!selectedSection || selectedSection === 'added') && (
                                        <div className="mb-6">
                                            <div className="flex items-center gap-2 mb-3">
                                    ...
                                    {/* Changed */}
                                    {entry.changed && entry.changed.length > 0 && (!selectedSection || selectedSection === 'changed') && (
                                        <div className="mb-6">
                                            <div className="flex items-center gap-2 mb-3">
                                    ...
                                    {/* Fixed */}
                                    {entry.fixed && entry.fixed.length > 0 && (!selectedSection || selectedSection === 'fixed') && (
                                        <div className="mb-6">
                                            <div className="flex items-center gap-2 mb-3">
                        ...
                        {filteredChangelog.length === 0 && (
                            <div className="text-center py-16">
                                <p className="text-textSecondary text-lg">No changelog entries found matching your search.</p>
                            </div>
                        )}
                    </div>
                </div>
