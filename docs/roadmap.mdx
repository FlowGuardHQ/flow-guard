---
title: "Roadmap"
description: "Features and improvements not yet in production. Every item here is feasible on BCH/CashTokens as of today or pending a specific, named CHIP. Nothing speculative."
icon: "map"
---
