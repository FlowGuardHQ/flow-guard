...
{
  "success": true,
  "proposalContractAddress": "bitcoincash:p...",
  "tokenCategory": "hex32",
...
Vault signer initiates the 2-of-2 payout signing session. Returns a `wcTransaction` with `"broadcast": false` — the wallet must sign but not broadcast.
...
```json
{
  ...
  "requiredSignerAddresses": ["bitcoincash:q...", "bitcoincash:q..."],
